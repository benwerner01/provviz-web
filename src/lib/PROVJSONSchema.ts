export default {
  ...
  definitions: {
    ...
    activity: {
      type: 'object', title: 'activity', 'prov:startTime': { type: 'string', format: 'date-time' }, 'prov:endTime': { type: 'string', format: 'date-time' }, additionalProperties: { $ref: '#/definitions/attributeValues' },
    },
    generation: {
      type: 'object', title: 'generation/usage', properties: { 'prov:entity': { type: 'string', format: 'uri' }, 'prov:activity': { type: 'string', format: 'uri' }, 'prov:time': { type: 'string', format: 'date-time' } }, required: ['prov:entity'], additionalProperties: { $ref: '#/definitions/attributeValues' },
    },
